...
RegisterNUICallback("settingtoggle", function(data, cb)
	...
	elseif(action=="radiooff")then
		...
		drawNotification("Radio toujours éteinte : "..text)
	...
	elseif(action=="mobileradio")then
		...
		drawNotification("Radio portable : "..text)
